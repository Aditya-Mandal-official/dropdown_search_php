...
<body>
    ...
    <button type="button" class="btn btn-primary mt-5 ms-5" data-bs-toggle="modal" data-bs-target="#country_modal">
    Country Modal
    </button>
    ...
    <div class="modal fade" id="country_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Country Search</h5>
            ...
            <div class="modal-body" >
                ...
                <datalist id="browsers">
                    ...
                    ?>
                    <option value="<?php echo $fetch['country_name']; ?>" >
                    <?php    } ?>
                </datalist>
